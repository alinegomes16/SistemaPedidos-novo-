...
!function(a,b){
    ...
    function p(a,b){
        ...
        var q="3.1.1 -ajax,-ajax/jsonp,-ajax/load,-ajax/parseXML,-ajax/script,-ajax/var/location,-ajax/var/nonce,-ajax/var/rquery,-ajax/xhr,-manipulation/_evalUrl,-event/ajax,-effects,-effects/animatedSelector,-effects/Tween,-deprecated",r=function(a,b){
...
function ib(a,b,c,d){
    ...
    if(r.isArray(a)||a.jquery&&!r.isPlainObject(a))r.each(a,function(){
        ...
        });else for(c in a)ib(c,a[c],b,e);return d.join("&")
    },r.fn.extend({
    serialize:function(){
